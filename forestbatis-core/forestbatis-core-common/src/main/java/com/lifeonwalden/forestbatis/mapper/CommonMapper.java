...
public interface CommonMapper<P> {
     ...
     * @return
     */
    List<P> select(P param, SQLBuilder sqlBuilder, StreamResultSetCallback streamResultSetCallback);
     ...
     * @return
     */
    List<P> select(P param, SQLBuilder sqlBuilder, RecordHandler resultHandler);
     ...
     * @return
     */
    void select(P param, SQLBuilder sqlBuilder, RecordHandler resultHandler, StreamResultSetCallback streamResultSetCallback);
     ...
     * @return
     */
    Integer updateWithQuery(P value, P param, SQLBuilder sqlBuilder);
     ...
     * @return
     */
    List<Integer> updateWithQuery(List<P> valueList, List<P> paramList, SQLBuilder sqlBuilder);
     ...
     * @return
     */
    Integer insert(P value, SQLBuilder sqlBuilder);
     ...
     * @return
     */
    List<Integer> insert(List<P> valueList, SQLBuilder sqlBuilder);
