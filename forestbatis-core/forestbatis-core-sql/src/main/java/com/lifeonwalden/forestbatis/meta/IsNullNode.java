 ...
 * @param <T>
 */
public class IsNullNode<T> extends AbstractQueryNode<T> {
    /**
     * 构造函数
     *
     * @param column 表字段
     */
    public IsNullNode(ColumnMeta column) {
        this(column, null);
    }
     ...
     */
    public IsNullNode(ColumnMeta column, Function<T, Boolean> enableCheck) {
        this.column = column;
