...
public class ParserTest {
    ...
    public void oneParameter() {
        ...
        if (logger.isDebugEnabled()) {
            Assert.assertTrue(statementInfo.getDebugSql(), "select * from User where id = '#1'".equals(statementInfo.getDebugSql()));
        }
        ...
        Assert.assertTrue("id index is not right : ".concat(String.valueOf(idPropertyInfo.getIndex())), idPropertyInfo.getIndex() == 1);
    ...
    public void twoParameter() {
        ...
        if (logger.isDebugEnabled()) {
            Assert.assertTrue(statementInfo.getDebugSql(), "select * from User where id = '#1' and name like '#2'".equals(statementInfo.getDebugSql()));
        }
        ...
        Assert.assertTrue("name index is not right : ".concat(String.valueOf(namePropertyInfo.getIndex())), namePropertyInfo.getIndex() == 2);
    ...
    public void twoParameterWithList() {
        ...
        if (logger.isDebugEnabled()) {
            Assert.assertTrue(statementInfo.getDebugSql(), "select * from User where id = '#1' and name like '#2' and sex in (#3, #4)".equals(statementInfo.getDebugSql()));
        }
        ...
        Assert.assertTrue("sex0 index is not right : ".concat(String.valueOf(sex0PropertyInfo.getIndex())), sex0PropertyInfo.getIndex() == 3);
        ...
        Assert.assertTrue("sex1 index is not right : ".concat(String.valueOf(sex1PropertyInfo.getIndex())), sex1PropertyInfo.getIndex() == 4);
    ...
    public void update() {
        ...
        if (logger.isDebugEnabled()) {
            Assert.assertTrue(statementInfo.getDebugSql(), "Update User set name = '#1', sex = '#2' where id = #3".equals(statementInfo.getDebugSql()));
        }
        ...
        Assert.assertTrue("id jdbc type is not right : ".concat(idPropertyInfo.getJdbcType().getName()), idPropertyInfo.getJdbcType() == JdbcType.INTEGER);
        Assert.assertTrue("id name is not right : ".concat(idPropertyInfo.getName()), idPropertyInfo.getName().equals("id"));
        Assert.assertTrue("id index is not right : ".concat(String.valueOf(idPropertyInfo.getIndex())), idPropertyInfo.getIndex() == 3);
        Assert.assertTrue("id listProperty is not right : ".concat(String.valueOf(idPropertyInfo.isListProperty())), idPropertyInfo.isListProperty() == false);
    ...
    public void delete() {
        ...
        if (logger.isDebugEnabled()) {
            Assert.assertTrue(statementInfo.getDebugSql(), "delete from User where id = #1".equals(statementInfo.getDebugSql()));
        }
    ...
    public void insert() {
        ...
        if (logger.isDebugEnabled()) {
            Assert.assertTrue(statementInfo.getDebugSql(), "insert into User(id, name, sex) values(#1, '#2', '#3')".equals(statementInfo.getDebugSql()));
        }
    ...
    public void subSelect() {
        ...
        if (logger.isDebugEnabled()) {
            Assert.assertTrue(statementInfo.getDebugSql(), "select * from User u where exists (select 1 from Item i where u.id=i.userId) and name like '#1'".equals(statementInfo.getDebugSql()));
        }
    ...
    public void join() {
        ...
        if (logger.isDebugEnabled()) {
            Assert.assertTrue(statementInfo.getDebugSql(), "select u.id, u.name, i.name from User u left join Item i on (u.id = i.userId and i.type = #1) where u.name like '#2'".equals(statementInfo.getDebugSql()));
        }
        ...
        Assert.assertTrue("type index is not right : ".concat(String.valueOf(idPropertyInfo.getIndex())), idPropertyInfo.getIndex() == 1);
